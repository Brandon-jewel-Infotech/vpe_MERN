...
const Dashboard = () => {
  ...
  const [dashboardData, setDashboardData] = useState([
    {
      ...
      value: 0,
      className: "w-[95%] sm:w-[53.7%] lg:w-[23.7%] bg-accent ",
    },
    {
      Icon: BsLayoutTextSidebarReverse,
      title: "Total Sub-Categories",
      value: 0,
      className: "w-[95%] sm:w-[53.7%] lg:w-[25%] bg-[#9937BC] ",
    },
    {
      Icon: BsLayoutTextSidebarReverse,
      title: "Total Sale",
      value: 0,
      className: "w-[95%] sm:w-[53.7%] lg:w-[22%] bg-primary ",
    },
    {
      Icon: BsLayoutTextSidebarReverse,
      title: "Total Employee",
      value: 0,
      className: "w-[95%] sm:w-[53.7%] lg:w-[23.7%] bg-[#FF7C7F]",
    },
    {
      Icon: BsLayoutTextSidebarReverse,
      title: "Completed Orders",
      value: "$10,000.00",
      className: "w-[95%] sm:w-[53.7%] lg:w-[32.2%] bg-[#FF7C7F]",
    },
    {
      Icon: BsLayoutTextSidebarReverse,
      title: "Pending Orders",
      value: 0,
      className: "w-[95%] sm:w-[53.7%] lg:w-[32.2%] bg-accent",
    },
    {
      Icon: BsLayoutTextSidebarReverse,
      title: "Cancelled Orders",
      value: 0,
      className: "w-[95%] sm:w-[53.7%] lg:w-[32.2%] bg-[#9937BC]",
    },
  ]);
  ...
  const getSalesStatistics = async () => {
    ...
    try {
      const { data } = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/seller/statistics`,
        {
          headers: {
            Authorization: tok,
          },
  ...
  const getChartData = async () => {
    ...
    try {
      const { data } = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/seller/chart-data`,
        {
          headers: {
            Authorization: tok,
          },
